# Oregon Catholic Press Azure SDK

This project is the Oregon Catholic Press fork of the Microsoft SDK that provides a set of PHP client libraries that make it easy to access
